...
class Verifier
{
     ...
     * @param string $now
     *   The current date in the UTC timezone in ISO-8601 (YYYY-MM-DD), for csig expiration tests. (optional; default: today.)
     */
     function __construct($public_key_raw, $now = null) {
